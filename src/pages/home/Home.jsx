...
export default function Home() {
  ...
  return (
    <div className="home">
      ...
      <Stack className="featuredItem2" sx={{ display:{xs:'none', sm:'none', md:'block'}, width:{xs:'80%', sm: '80%', md:'50%'}, border:'1px solid blue', background:'white'}}>
      ...
      <Box sx={{ display:{xs:'block', sm:'block', md:'none'} }}>
        <FeaturedInfo progress={progress} title={'Current Storage size'} date={date} data={totalSizeInGB}/>
      </Box>
